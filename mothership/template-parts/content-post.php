...
<div class="container single-page">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="col-12 col-md-4 col-lg-4">
				<div id="sticky-sidebar" class="sticky-top">
					...
					<div class="article_zip_lead">
						<div class="article_zip_lead--header" style="background-image: url(<?php echo $image_right_zip_lead ?>);">
							...
							<div class="row">
								...
								<div class="col-6 col-md-12 col-lg-12">
									<?php 
									$hcinc_redirect_to_the_flow = get_field('hcinc_redirect_to_the_flow', 'option');  
									$start_here_product = get_field('hcinc_product', 'option');

									if($start_here_product == 'HEALTH'){
										$start_here_product_content = 'healthcare-insurance/initial/';
									}else{
										$start_here_product_content = 'medicare-insurance/initial/';
									}

									if($hcinc_redirect_to_the_flow){
										echo '<a id="article_zip_lead_start" href="'.home_url().'/'.$start_here_product_content.'">Start Here</a>';
									} else {
										echo 'https://healthcare.com/'.$start_here_product_content;
									} 
									?>
								</div>
							</div>
		...
		<div class="inArticle-footer-ads">
			<div class="row">
				<div class="col-12">
					...
					<script type="text/javascript">
					  hc.sem.insertRotationToolsAds({
					    ...
					    howMany: 4,
					    disclaimer: '',
					    product: '<?php if ( ! empty( $inArticleAdsProduct ) ) { echo $inArticleAdsProduct; } ?>'
					  });
					</script>
					<?php } else { ?>
						<script src="https://assets.healthcare.com/hc-sem.min.js"></script>
